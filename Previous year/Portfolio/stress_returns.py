...
class IIDAssetPortfolioSimulator:
    def __init__(self, data_file='portfolio_data.csv', output_dir="results", asset_drags=None):
        ...
        # Default drags (annualized). Can be overwritten when instantiating.
        self.asset_drags = asset_drags or {}
